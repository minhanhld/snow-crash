...
Then it checks the result, if the pointer is different from NULL, basically meaning that there IS token in the filename, then it says that the file is not accessible and exits immediately.
