...
After decompiling it and analyzing what ghidra shows us, we understand that the function hash the input, by basically adding the index to the i-th character of the input, so for example : 
